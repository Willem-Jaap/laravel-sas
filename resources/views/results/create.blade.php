    ...
    <div class="min-h-screen flex-1">
        ...
        <main class="flex justify-center bg-gray-50 px-8 py-7">
            <div class="max-w-md w-full">
                <h2 class="text-2xl ml-3 font-extrabold text-gray-900">Maak een nieuw resultaat aan.</h2>

                <form class="space-y-6" method="POST" action="{{ route('results.store') }}">
                    @csrf
