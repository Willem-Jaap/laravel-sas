            ...
            <div class="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p class="mt-2 text-center text-sm text-gray-600">
                        ...
                        of <a class="font-medium text-indigo-600 hover:text-indigo-500" href="{{ route('register') }}">maak een
                            account aan.</a>
                    </p>
                </div>
            </div>
        ...
        @auth
            <div class="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p class="mt-2 text-center text-sm text-gray-600">Klik <a
                            class="font-medium text-indigo-600 hover:text-indigo-500"
                            href="{{ route('students.index') }}">hier</a> om naar studenten te bekijken.</p>
                </div>
            </div>
        @endauth
    </div>
